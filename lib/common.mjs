...
// Falls back to Uniscore if Livesport is unreachable.
export async function resolveTeam(name) {
  const q = encodeURIComponent(queryTeam(name));
  // Try Livesport first with retry for transient errors
  let teams = [];
  try {
